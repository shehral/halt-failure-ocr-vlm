...
All paths below are **relative to `results/`** in this repository. Source artifacts were
...
| EOS-margin | Relative-not-absolute EOS | chosen-EOS margin ~20.6; P(EOS) 1e-8...1e-10; cap-hit EOS logit +10.76 > control +10.07 | `demo_eos_failure/03_eos_trajectories/docvqa_srgb0228_p2_eos_trace.json` |
